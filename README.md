...
**An example webmap of the kind of output it creates and how it works and can be found [here](https://goo.gl/vD27Ii)**
...
*The picture above gives some insight on how the lines algorithm works internally.*
